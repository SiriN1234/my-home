...
def show_house_type():
    ...
    if welfare_type == '공공임대주택':
        house_data = pd.read_csv("./service_guide_data/house_welfare/public_lease/housing_type.csv")
    # ------------------------------------------------------------------------------------
...
def show_special_supply():
    ...
    # ----- data url ---------------------------------------------------------------------
    if welfare_type == '공공임대주택':
        supply_data = pd.read_csv("./service_guide_data/house_welfare/public_lease/special_supply.csv")
    # ------------------------------------------------------------------------------------
