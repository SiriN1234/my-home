...
driver.find_element_by_xpath('//*[@id="schMapDiv"]/div[1]/div[1]/div[2]/span[5]/a/img').click()
...
df.to_csv('./region_data/Gyeongbuk_notice.csv', index = False, encoding='utf-8')
...
df.to_csv('./region_data/Gyeongbuk_url.csv', index = False, encoding='utf-8')