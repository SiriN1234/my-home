...
driver.find_element_by_xpath('//*[@id="schMapDiv"]/div[1]/div[1]/div[2]/span[17]/a/img').click()
...
df.to_csv('./region_data/Jeju_notice.csv', index = False, encoding='utf-8')
...
df.to_csv('./region_data/Jeju_url.csv', index = False, encoding='utf-8')