...
driver.find_element_by_xpath('//*[@id="schMapDiv"]/div[1]/div[1]/div[2]/span[3]/a/img').click()
...
incheon_area_list = []
incheon_name_list = []
incheon_re_date_list = []
incheon_pre_date_list = []
incheon_corporation_list = []
...
for i in range(10):
        ...
        incheon_title_list.append(title)
        incheon_status_list.append(status)
        incheon_area_list.append(area)
        incheon_name_list.append(name1)
        incheon_re_date_list.append(re_date)
        incheon_pre_date_list.append(pre_date)
        incheon_corporation_list.append(corporation)
        print(i)
    
for i in range(len(incheon_area_list)):
    incheon_area_list[i] = incheon_area_list[i].replace('\n', '')
...
df.to_csv('./Incheon_notice.csv', index = False, encoding='utf-8')
...
df.to_csv('./Incheon_url.csv', index = False, encoding='utf-8')