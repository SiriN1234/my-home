...
driver.find_element_by_xpath('//*[@id="schMapDiv"]/div[1]/div[1]/div[2]/span[11]/a/img').click()
...
df.to_csv('./Daejeon_notice.csv', index = False, encoding='utf-8')
...
df.to_csv('./Daejeon_url.csv', index = False, encoding='utf-8')